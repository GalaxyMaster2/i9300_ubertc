...
cd ../../binutils/binutils-uber && rm -rf * && git reset --hard && git fetch uu 2.26 && git checkout FETCH_HEAD;
cd ../../
...
export UBER_PATH=$DIR/out/arm-cortex_a9-linux-androideabi-7.x;
